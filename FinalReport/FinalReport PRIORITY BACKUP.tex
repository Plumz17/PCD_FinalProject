...
Sensitivity calculates out of all the positive cases how many did the model actually detect, a low recall means that the model will not be able to diagnose or identify TBC patients correctly. Sensitivity is calculated using the formula:
\begin{equation}
